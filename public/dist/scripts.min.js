...
!function(){"use strict";angular.module("net.bobhennessey.home",[]),angular.module("net.bobhennessey.beers",[]),angular.module("net.bobhennessey.utils",[]),angular.module("net.bobhennessey.dependencies",["ui.router"]),angular.module("net.bobhennessey",["net.bobhennessey.dependencies","net.bobhennessey.utils","net.bobhennessey.home","net.bobhennessey.beers"])}();
!function(){"use strict";function e(e,t){e.state({name:"layout","abstract":!0,templateUrl:"views/layout.html"}).state({name:"layout.home",url:"/",templateUrl:"app/modules/home/index.html"}).state({name:"layout.beers",url:"/beers",templateUrl:"app/modules/beers/index.html"}),t.html5Mode(!0)}angular.module("net.bobhennessey").config(e),e.$inject=["$stateProvider","$locationProvider"]}();
!function(){"use strict";function e(e){var t=this,n=function(){t.title="Beer Time.",e.getBeers().then(function(e){t.beers=e.data})};n()}angular.module("net.bobhennessey.home").controller("beerCtrl",e),e.$inject=["beerService"]}();
!function(){"use strict";function e(e){function r(r,n,t,i){"undefined"==typeof r.beer&&(r.beer=e.newBeer(),r.beer.isEditing=!0)}var n={};return n.restrict="E",n.templateUrl="app/modules/beers/beerForm.html",n.scope={beer:"=?"},n.link=r,n}angular.module("net.bobhennessey.beers").directive("beerForm",e),e.$inject=["beerService"]}();
!function(){"use strict";function e(e){function n(e,n,t,r){this.name="undefined"==typeof e?"":e,this.brewer="undefined"==typeof n?"":n,this.style="undefined"==typeof t?"":t,this.abv="undefined"==typeof r?0:r}var t={};return t.getBeers=function(){return e.get("/api/beers")},t.getBeer=function(n){return e.get("/api/beers/id")},t.addBeeer=function(n){return e.post("/api/beers",n)},t.newBeer=function(){return new n},t}angular.module("net.bobhennessey.beers").factory("beerService",e),e.$inject=["$http"]}();
!function(){"use strict";function e(){var e={};return e.restrict="E",e.templateUrl="app/modules/header/index.html",e}angular.module("net.bobhennessey.utils").directive("header",e),e.$inject=[]}();
!function(){"use strict";function e(){var e=this;e.title="bobhennessey.net"}angular.module("net.bobhennessey.home").controller("homeCtrl",e),e.$inject=[]}();